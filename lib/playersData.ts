...
export const playersData: Player[] = [
  ...
  { id: 26, name: "J2", top: 6, middle: 8, bottom: 9, supports: 4.5, jungle: 7, fighting: 4, diceHigh: 5, diceLow: 3, mental: 8, totalScore: 27.5, preferredPosition: ["middle", "bottom","jungle"] },
