...
export const playersData: Player[] = [
  ...
  { id: 3, name: "진수", top: 7.5, middle: 7.5, bottom: 9, supports: 8, jungle: 7, fighting: 9, diceHigh: 10, diceLow: 7, mental: 5, totalScore: 71, preferredPosition: ["bottom", "top"] },
  { id: 4, name: "코봉이", top: 5, middle: 7, bottom: 7, supports: 6, jungle: 7, fighting: 7.5, diceHigh: 9, diceLow: 4, mental: 3, totalScore: 56.5, preferredPosition: ["middle", "jungle","bottom"] },
  { id: 5, name: "철수", top: 5, middle: 7.5, bottom: 8, supports: 7, jungle: 6, fighting: 7, diceHigh: 7, diceLow: 3, mental: 2, totalScore: 52, preferredPosition: ["bottom","middle","jungle"] },
  ...
  { id: 7, name: "붐야", top: 0, middle: 0, bottom: 0, supports: 4.5, jungle: 0, fighting: 4, diceHigh: 5, diceLow: 3, mental: 10, totalScore: 27, preferredPosition: ["supports"] },
  { id: 8, name: "소", top: 5, middle: 0, bottom: 3, supports: 3, jungle: 3, fighting: 5, diceHigh: 7, diceLow: 3, mental: 8, totalScore: 35, preferredPosition: ["top", "bottom", "jungle"] },
  ...
  { id: 16, name: "민우", top: 5, middle: 5, bottom: 3, supports: 2, jungle: 2, fighting: 5, diceHigh: 7, diceLow: 2, mental: 10, totalScore: 40, preferredPosition: ["middle", "top"] },
  ...
  { id: 19, name: "명준", top: 5, middle: 7, bottom: 7, supports: 6, jungle: 7, fighting: 8, diceHigh: 10, diceLow: 5, mental: 5, totalScore: 61, preferredPosition: ["middle", "jungle"] },
  ...
  { id: 21, name: "태양", top: 2.5, middle: 2, bottom: 1, supports: 1, jungle: 0, fighting: 3, diceHigh: 5, diceLow: 2, mental: 8, totalScore: 26, preferredPosition: ["top", "middle"] },
